    ...
    >
      ...
      ${e?r`
            <div style="background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.2);padding:8px 10px;border-radius:8px;font-size:0.8rem;color:#6ee7b7;display:flex;flex-direction:column;gap:3px;">
              ...
              ${t.soldAt?r`<div style="font-size:0.75rem;color:var(--text-dim);">Sold on ${L(t.soldAt)}</div>`:""}
            </div>
          `:s?r`
      ...
      <div class="card-footer">
        <div style="display:flex;flex-direction:column;gap:2px;">
          ...
          <div class="date-badge" title="${L(t.createdAt)}">
            📅 ${_e(t.createdAt)} (${L(t.createdAt)})
          </div>
        </div>
        <button
          class="danger sm"
                  ...
                  <div class="item-card" style="border-left: 3px solid var(--warning);">
                    ...
                    <div class="card-footer">
                      <div style="display:flex;flex-direction:column;gap:2px;">
                        ...
                        <div class="date-badge" title="${L(e.createdAt)}">
                          📅 ${_e(e.createdAt)} (${L(e.createdAt)})
                        </div>
                      </div>
                  ...
                  >
                    ...
                    >
                      ${i.status==="fulfilled"?r`
                            ...
                            <div style="margin-top:6px;display:flex;flex-direction:column;gap:3px;font-size:0.8rem;color:var(--text-muted);">
                              ...
                              ${p!=null&&p.soldAt||i.matchedAt?r`<div>Completed: <strong>${L((p==null?void 0:p.soldAt)||i.matchedAt)}</strong></div>`:""}
                            </div>
                    ...
                    <div class="card-footer">
                      <div style="display:flex;flex-direction:column;gap:2px;">
                        ...
                        <div class="date-badge" title="${L(i.createdAt)}">
                          ${_e(i.createdAt)} (${L(i.createdAt)})
                        </div>
                      </div>
                      <div style="display:flex;gap:6px;">
                        ${i.status!=="fulfilled"?r`

...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Le=/'/g,Re=/"/g,je=/^(?:script|style|textarea|title)$/i,xt=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),r=xt(1),se=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Be=new WeakMap,N=z.createTreeWalker(z,129);function Ue(t,e){if(!Ce(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return He!==void 0?He.createHTML(e):e}const $t=(t,e)=>{const s=t.length-1,a=[];let i,n=e===2?"<svg>":e===3?"<math>":"",o=G;for(let l=0;l<s;l++){const d=t[l];let v,f,p=-1,g=0;for(;g<d.length&&(o.lastIndex=g,f=o.exec(d),f!==null);)g=o.lastIndex,o===G?f[1]==="!--"?o=Te:f[1]!==void 0?o=De:f[2]!==void 0?(je.test(f[2])&&(i=RegExp("</"+f[2],"g")),o=L):f[3]!==void 0&&(o=L):o===L?f[0]===">"?(o=i??G,p=-1):f[1]===void 0?p=-2:(p=o.lastIndex-f[2].length,v=f[1],o=f[3]===void 0?L:f[3]==='"'?Re:Le):o===Re||o===Le?o=L:o===Te||o===De?o=G:(o=L,i=void 0);const x=o===L&&t[l+1].startsWith("/>")?" ":"";n+=o===G?d+bt:p>=0?(a.push(v),d.slice(0,p)+ze+d.slice(p)+M+x):d+M+(p===-2?l:x)}return[Ue(t,n+(t[s]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),a]};class ie{constructor({strings:e,_$litType$:s},a){let i;this.parts=[];let n=0,o=0;const l=e.length-1,d=this.parts,[v,f]=$t(e,s);if(this.el=ie.createElement(v,a),N.currentNode=this.el.content,s===2||s===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(i=N.nextNode())!==null&&d.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(const p of i.getAttributeNames())if(p.endsWith(ze)){const g=f[o++],x=i.getAttribute(p).split(M),w=/([.?@])?(.*)/.exec(g);d.push({type:1,index:n,name:w[2],strings:x,ctor:w[1]==="."?St:w[1]==="?"?kt:w[1]==="@"?wt:ue}),i.removeAttribute(p)}else p.startsWith(M)&&(d.push({type:6,index:n}),i.removeAttribute(p));if(je.test(i.tagName)){const p=i.textContent.split(M),g=p.length-1;if(g>0){i.textContent=de?de.emptyScript:"";for(let x=0;x<g;x++)i.append(p[x],ee()),N.nextNode(),d.push({type:2,index:++n});i.append(p[g],ee())}}}else if(i.nodeType===8)if(i.data===Oe)d.push({type:2,index:n});else{let p=-1;for(;(p=i.data.indexOf(M,p+1))!==-1;)d.push({type:7,index:n}),p+=M.length-1}n++}}static createElement(e,s){const a=z.createElement("template");return a.innerHTML=e,a}}function W(t,e,s=t,a){var o,l;if(e===se)return e;let i=a!==void 0?(o=s._$Co)==null?void 0:o[a]:s._$Cl;const n=te(e)?void 0:e._$litDirective$;return(i==null?void 0:i.constructor)!==n&&((l=i==null?void 0:i._$AO)==null||l.call(i,!1),n===void 0?i=void 0:(i=new n(t),i._$AT(t,s,a)),a!==void 0?(s._$Co??(s._$Co=[]))[a]=i:s._$Cl=i),i!==void 0&&(e=W(t,i._$AS(t,e.values),i,a)),e}class At{constructor(e,s){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:s},parts:a}=this._$AD,i=((e==null?void 0:e.creationScope)??z).importNode(s,!0);N.currentNode=i;let n=N.nextNode(),o=0,l=0,d=a[0];for(;d!==void 0;){if(o===d.index){let v;d.type===2?v=new re(n,n.nextSibling,this,e):d.type===1?v=new d.ctor(n,d.name,d.strings,this,e):d.type===6&&(v=new Ct(n,this,e)),this._$AV.push(v),d=a[++l]}o!==(d==null?void 0:d.index)&&(n=N.nextNode(),o++)}return N.currentNode=z,i}p(e){let s=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(e,a,s),s+=a.strings.length-2):a._$AI(e[s])),s++}}class re{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,s,a,i){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=s,this._$AM=a,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=s.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,s=this){e=W(this,e,s),te(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==se&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):yt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&te(this._$AH)?this._$AA.nextSibling.data=e:this.T(z.createTextNode(e)),this._$AH=e}$(e){var n;const{values:s,_$litType$:a}=e,i=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=ie.createElement(Ue(a.h,a.h[0]),this.options)),a);if(((n=this._$AH)==null?void 0:n._$AD)===i)this._$AH.p(s);else{const o=new At(i,this),l=o.u(this.options);o.p(s),this.T(l),this._$AH=o}}_$AC(e){let s=Be.get(e.strings);return s===void 0&&Be.set(e.strings,s=new ie(e)),s}k(e){Ce(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let a,i=0;for(const n of e)i===s.length?s.push(a=new re(this.O(ee()),this.O(ee()),this,this.options)):a=s[i],a._$AI(n),i++;i<s.length&&(this._$AR(a&&a._$AB.nextSibling,i),s.length=i)}_$AR(e=this._$AA.nextSibling,s){var a;for((a=this._$AP)==null?void 0:a.call(this,!1,!0,s);e!==this._$AB;){const i=Me(e).nextSibling;Me(e).remove(),e=i}}setConnected(e){var s;this._$AM===void 0&&(this._$Cv=e,(s=this._$AP)==null||s.call(this,e))}}class ue{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,s,a,i,n){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=s,this._$AM=i,this.options=n,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=b}_$AI(e,s=this,a,i){const n=this.strings;let o=!1;if(n===void 0)e=W(this,e,s,0),o=!te(e)||e!==this._$AH&&e!==se,o&&(this._$AH=e);else{const l=e;let d,v;for(e=n[0],d=0;d<n.length-1;d++)v=W(this,l[a+d],s,d),v===se&&(v=this._$AH[d]),o||(o=!te(v)||v!==this._$AH[d]),v===b?e=b:e!==b&&(e+=(v??"")+n[d+1]),this._$AH[d]=v}o&&!i&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class St extends ue{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}}class kt extends ue{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}}class wt extends ue{constructor(e,s,a,i,n){super(e,s,a,i,n),this.type=5}_$AI(e,s=this){if((e=W(this,e,s,0)??b)===se)return;const a=this._$AH,i=e===b&&a!==b||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,n=e!==b&&(a===b||i);i&&this.element.removeEventListener(this.name,this,a),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,e):this._$AH.handleEvent(e)}}class Ct{constructor(e,s,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=s,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){W(this,e)}}const he=Q.litHtmlPolyfillSupport;he==null||he(ie,re),(Q.litHtmlVersions??(Q.litHtmlVersions=[])).push("3.3.3");const _t=(t,e,s)=>{const a=e;let i=a._$litPart$;return i===void 0&&(a._$litPart$=i=new re(e.insertBefore(ee(),null),null,void 0,{})),i._$AI(t),i},Pt=document.getElementById("app");let m="available",I="all",$=[],A=[],ce=[],Et=null,R=null,ae=!1,Z="",me=null,D="",_="all",H="all",F="all",O="all",C="all",B="holds",P="all",oe="",ne="",X=!0,j=!1,S=null,Ae=!1,V=!1,q="",le="",be="Mathematics",ye="+15550199002";function h(t){Z=t,me&&clearTimeout(me),me=setTimeout(()=>{Z="",u()},1e4)}function _e(t){if(!t)return"Unknown date";const e=Date.now(),s=Math.floor((e-t)/1e3);if(s<60)return"Just now";const a=Math.floor(s/60);if(a<60)return`${a}m ago`;const i=Math.floor(a/60);if(i<24)return`${i}h ago`;const n=Math.floor(i/24);return n===1?"Yesterday":n<30?`${n}d ago`:new Date(t).toLocaleDateString()}function T(t){return t?new Date(t).toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):""}function pe(t){switch(t){case"Mathematics":return"badge-math";case"Science":return"badge-science";case"Languages":return"badge-languages";case"Humanities":return"badge-humanities";case"Arts":return"badge-arts";default:return"badge-active"}}function We(t){switch(t){case"PrimarySchool":return"badge-primary";case"MiddleSchool":return"badge-middle";case"HighSchool":return"badge-high";case"UniversityPrep":return"badge-uniprep";default:return"badge-active"}}function It(t){switch(t){case"PrimarySchool":return"Primary (Years 1-6)";case"MiddleSchool":return"Middle School (Years 7-9)";case"HighSchool":return"High School (Years 10-13)";case"UniversityPrep":return"Uni Prep";default:return t||"General"}}function Fe(t){switch(t){case"New":return r`
      ...
      `;default:return r`<span class="badge badge-active">${t||"Good"}</span>`}}function Ye(t){if(!t)return!0;const e=Date.now();if(P==="today"){const s=new Date;return s.setHours(0,0,0,0),t>=s.getTime()}if(P==="7days"){const s=e-6048e5;return t>=s}if(P==="30days"){const s=e-2592e6;return t>=s}if(P==="custom"){let s=!0;if(oe){const a=new Date(oe).setHours(0,0,0,0);t<a&&(s=!1)}if(ne){const a=new Date(ne).setHours(23,59,59,999);t>a&&(s=!1)}return s}return!0}function Mt(t){return t.filter(e=>{if(D.trim()){const s=D.toLowerCase().trim();if(!(e.title&&e.title.toLowerCase().includes(s)||e.concept&&e.concept.toLowerCase().includes(s)||e.description&&e.description.toLowerCase().includes(s)||e.domain&&e.domain.toLowerCase().includes(s)||e.providerCategory&&e.providerCategory.toLowerCase().includes(s)||e.sellerPhone&&e.sellerPhone.toLowerCase().includes(s)))return!1}return!(_!=="all"&&e.domain!==_||H!=="all"&&e.providerCategory!==H||F!=="all"&&e.conditionType!==F||O!=="all"&&e.sellerPhone!==O||C!=="all"&&e.status!==C||!Ye(e.createdAt))}).sort((e,s)=>{const a=e.createdAt||0,i=s.createdAt||0;return X?i-a:a-i})}function Se(t,e){return t.filter(s=>{if(s.status!==e)return!1;if(D.trim()){const a=D.toLowerCase().trim();if(!(s.requestedQuery&&s.requestedQuery.toLowerCase().includes(a)||s.concept&&s.concept.toLowerCase().includes(a)||s.domain&&s.domain.toLowerCase().includes(a)||s.userPhone&&s.userPhone.toLowerCase().includes(a)||s.handoverCode&&s.handoverCode.toLowerCase().includes(a)))return!1}return!(_!=="all"&&s.domain!==_||!Ye(s.createdAt))}).sort((s,a)=>{const i=s.matchedAt||s.createdAt||0,n=a.matchedAt||a.createdAt||0;return X?n-i:i-n})}function Ht(){let t=0;return D.trim()&&t++,_!=="all"&&t++,H!=="all"&&t++,F!=="all"&&t++,O!=="all"&&t++,C!=="all"&&t++,P!=="all"&&t++,t}function Ge(){D="",_="all",H="all",F="all",O="all",C="all",P="all",oe="",ne="",u()}async function k(){ae=!0,u();try{try{await y.releaseExpiredHolds()}catch{}const[t,e,s,a,i]=await Promise.all([y.listInventory(),y.listDemands(),y.getLifecycleEvents(),y.getSecurityObservabilityStatus(),y.getSupplyGaps()]);$=t||[],A=e||[],ce=s||[],Et=a||null,R=i||null}catch(t){console.error("Failed to load dashboard data:",t),h(`❌ Failed to load data: ${t.message}`)}finally{ae=!1,u()}}async function Tt(t){Ae=!0,j=!0,S=null,u();try{S=await y.getSellerStorefront(t)}catch(e){h(`❌ Failed to load seller storefront: ${e.message}`),j=!1}finally{Ae=!1,u()}}async function Dt(){try{const t=await y.verifyWebhook("subscribe","my_verify_token_123",`challenge_${Date.now()}`);t.status===200?h(`✅ Handshake Verified! Echoed challenge: "${t.challenge}"`):h(`❌ Verification failed: ${t.error}`)}catch(t){h(`❌ Error verifying webhook: ${t.message}`)}k()}async function U(t,e="+15550199001"){var s,a,i,n;h(`🚀 Processing simulated WhatsApp message: "${t}"...`),u();try{const o={media_id:`media_${Date.now()}`,from_phone:e,message_text:t},l=await y.handleWebhook(o);((s=l.result)==null?void 0:s.status)==="matched"?(h(`🎉 Match Connected! Matched wishlist ID: ${l.result.matchedDemandId}`),m="matches"):((a=l.result)==null?void 0:a.status)==="needs_year_clarification"?h("ℹ️ Clarification Prompt Triggered: Bot asked parent for school year/grade!"):((i=l.result)==null?void 0:i.status)==="greeting"?h("👋 Greeting Handled: Welcome & Guide sent."):(h(`📦 Book Listed into Inventory! Item ID: ${((n=l.result)==null?void 0:n.itemId)||"saved"}`),m="available")}catch(o){h(`❌ Webhook simulation error: ${o.message}`)}k()}async function ke(t,e,s="Mathematics",a="+15550199002"){h(`⏳ Registering demand for "${e}" (${t})...`),u();try{const i=await y.createDemand(a,e,t,s);h(`✨ Wishlist demand registered: "${i.requestedQuery}"!`),V=!1,m="pendings"}catch(i){h(`❌ Error adding demand: ${i.message}`)}k()}async function qe(t){try{await y.deleteDemand(t),h("🗑️ Removed demand entry."),A=A.filter(e=>e.demandId!==t),u()}catch(e){h(`❌ Error removing demand: ${e.message}`)}}async function Lt(t){try{await y.deleteInventory(t),h("🗑️ Removed inventory item."),$=$.filter(e=>e.itemId!==t),u()}catch(e){h(`❌ Error removing inventory: ${e.message}`)}}async function Ve(){h("🔒 Validating HMAC-SHA256 Payload Signature..."),u();try{const t="secret_key_whatsapp_demo_1234",e=JSON.stringify({test:"hmac-verification",timestamp:Date.now()}),s=new TextEncoder,a=await crypto.subtle.importKey("raw",s.encode(t),{name:"HMAC",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("HMAC",a,s.encode(e)),n=Array.from(new Uint8Array(i)).map(l=>l.toString(16).padStart(2,"0")).join("");(await y.validateSignature(e,`sha256=${n}`,t)).valid?h("🛡️ HMAC Verification SUCCESS: Timing-safe cryptographic signature verified."):h("❌ HMAC Verification Failed!")}catch(t){h(`❌ HMAC test error: ${t.message}`)}k()}function Rt(){const t=A.filter(n=>n.status==="pending").length,e=A.filter(n=>n.status==="matched").length,s=A.filter(n=>n.status==="fulfilled").length||$.filter(n=>n.status==="sold").length,a=$.filter(n=>n.status==="active").length,i=ce.length;return r`
    <div class="stats-row">
      <div
        class="stat-card"
        style="cursor:pointer;"
        @click=${()=>{m="available",C="active",u()}}
      >
      ...
      >
        <div style="max-width:700px;">
          ...
          <p style="margin:0;font-size:0.88rem;color:var(--text-muted);line-height:1.4;">
            ...
            <strong
              >${R.deficitSubjects.map(t=>`${t.domain} (${t.count})`).join(", ")}</strong
            >
  ...
  `:""}function Pe(t=!0){const e=Ht(),s=Array.from(new Set($.map(a=>a.sellerPhone).filter(Boolean)));return r`
      ...
      <div class="toolbar-main">
        ...
        ${t?r`
                ...
                <select
                  class="filter-select"
                  .value=${C}
                  @change=${a=>{C=a.target.value,u()}}
                >
                  <option value="all">📦 All Statuses (${$.length})</option>
                  <option value="active">
                    🟢 Available (${$.filter(a=>a.status==="active").length})
                  </option>
                  <option value="reserved">
                    ⏳ On Hold (${$.filter(a=>a.status==="reserved").length})
                  </option>
                  <option value="sold">
                    🎓 Sold & Completed (${$.filter(a=>a.status==="sold").length})
                  </option>
                </select>
              `:""}
  ...
  `}function zt(){const t=Mt($);return r`
    <div class="card">
      <div class="card-header">
        <div>
          <h3>
            📚
            ${C==="sold"?"Sold & Completed Books Archive":C==="reserved"?"On-Hold Inventory":"Available Books Catalog"}
          </h3>
        ...
        <div style="display:flex;gap:10px;align-items:center;">
          ...
          <button class="secondary sm" @click=${k}>
      ...
      ${t.length===0?r`
            ...
            `:I==="all"?r` <div class="items-grid">${t.map(e=>Ee(e))}</div> `:I==="by-subject"?Ot(t):jt(t)}
    </div>
  ...
  `}function Ee(t){const e=t.status==="sold",s=t.status==="reserved";return r`
    ...
    >
        ...
        <div style="display:flex;gap:6px;align-items:center;">
          ${e?r`<span
                ...
                >`:s?r`<span
                    ...
                    >HOLD ⏳</span
                  >`:""}
          <span class="badge ${pe(t.domain)}"> ${t.domain} </span>
        </div>
      </div>
      ...
      ${t.description?r`<div style="font-size:0.84rem;color:var(--text-muted);line-height:1.4;">
              ${t.description}
            </div>`:""}
      ${e?r`
              <div
              ...
              >
                <div>
                  ...
                  ${t.soldToPhone?r`to <strong style="color:var(--text);">${t.soldToPhone}</strong>`:""}
                </div>
            ...
            `:s?r`
                ...
                >
                  ...
                  ${t.reservedForPhone?r`for <strong style="color:var(--text);">${t.reservedForPhone}</strong>`:""}
                </div>
              `:""}
    ...
    <div style="display:flex;flex-direction:column;gap:32px;">
      ${["Mathematics","Science","Languages","Humanities","Arts"].map(s=>{const a=t.filter(i=>i.domain===s);return a.length===0?"":r`
          <div>
            ...
            <div class="items-grid">${a.map(i=>Ee(i))}</div>
          </div>
        `})}
    </div>
      ...
      ${[{key:"PrimarySchool",label:"Primary School (Years 1 - 6)"},{key:"MiddleSchool",label:"Middle School (Years 7 - 9)"},{key:"HighSchool",label:"High School (Years 10 - 13)"},{key:"UniversityPrep",label:"University Prep"}].map(s=>{const a=t.filter(i=>i.providerCategory===s.key);return a.length===0?"":r`
          <div>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px;">
              ...
              <span class="badge ${We(s.key)}"
                >${a.length} Available</span
              >
            </div>
            <div class="items-grid">${a.map(i=>Ee(i))}</div>
          </div>
  ...
  `}function Ut(){return j?r`
    <div
      ...
      @click=${t=>{t.target===t.currentTarget&&(j=!1,u())}}
    >
      <div
        class="card"
      ...
      >
        ${Ae?r`<div style="text-align:center;padding:40px 0;color:var(--text-muted);">
                Loading Family Storefront...
                  ...
                  >
                    <div>
                      ...
                      <h3 style="font-size:1.4rem;">
                        Parent Storefront: ${S.sellerPhone}
                      </h3>
                      <p style="margin:4px 0 0 0;font-size:0.85rem;color:var(--text-muted);">
                        Total <strong>${S.totalBooks} textbooks</strong> available
                      ...
                      ${S.bundles.map(t=>r`
                          ...
                          >
                            ...
                            <div style="font-size:0.8rem;color:#60a5fa;margin-top:2px;">
                              ${t.count} Books Available
                            </div>
                            <button
                              class="secondary sm"
                              style="margin-top:8px;width:100%;font-size:0.72rem;"
                              @click=${()=>{h(`💬 WhatsApp Bundle Request sent to seller ${S==null?void 0:S.sellerPhone} for all ${t.count} books in ${t.grade}!`)}}
                            >
                      ...
                      ${S.items.map(t=>r`
                          ...
                          >
                            <div>
                              ...
                              <div style="font-size:0.75rem;color:var(--text-dim);">
                                ${t.domain} &bull; ${t.concept}
                              </div>
                            </div>
                            <div>${Fe(t.conditionType)}</div>
                          </div>
                        `)}
                    </div>
                  </div>
                  ...
                  >
                    <button
                      class="secondary"
                      @click=${()=>{O=(S==null?void 0:S.sellerPhone)||"all",j=!1,u()}}
                    >
  ...
  `:""}function Wt(){const t=Se(A,"pending");return r`
    <div class="card">
      <div class="card-header">
        <div>
      ...
      ${t.length===0?r`
              <div class="empty-state">
                ...
                <button
                  ...
                  @click=${()=>ke("Year5Chemistry","Year 5 Chemistry","Science")}
                >
                    ...
                    <div class="item-card" style="border-left: 3px solid var(--warning);">
                      ...
                      <div class="card-footer">
                        <div style="display:flex;flex-direction:column;gap:2px;">
                          <div style="font-size:0.75rem;color:var(--text-dim);">
                            Waiting Parent:
                            <strong style="color:var(--text);">${e.userPhone}</strong>
                          </div>
    ...
    ${V?r`
            <div
              ...
              @click=${e=>{e.target===e.currentTarget&&(V=!1,u())}}
            >
              <div
                class="card"
              ...
              >
                ...
                <div style="display:flex;flex-direction:column;gap:14px;">
                  ...
                  <div style="display:flex;gap:10px;justify-content:flex-end;margin-top:10px;">
                    ...
                    <button
                      @click=${()=>{q.trim()&&ke(le||q.replace(/[^a-zA-Z0-9]/g,""),q,be,ye)}}
                    >
                      Save Request
                    </button>
                  </div>
          ...
          `:""}
  `}function Ft(){const t=Se(A,"matched"),e=Se(A,"fulfilled"),s=B==="completed",a=s?e:t;return r`
    <div class="card">
      <div class="card-header">
        <div>
          <h3>
            ${s?"🎓 Completed Book Exchanges & Sold Archive":"🤝 Matched Pairs & 48-Hour Reservations"}
          </h3>
          <p style="margin:4px 0 0 0;font-size:0.9rem;color:var(--text-muted);">
        ...
        <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
          ...
          ${s?"":r`
                  <button
                    ...
                    @click=${async()=>{const i=await y.releaseExpiredHolds();h(`🧹 Swept holds: ${i.releasedCount} expired hold(s) released back to active inventory.`),await k()}}
                  >
                    🧹 Sweep Holds
                  </button>
                `}
      ...
      ${a.length===0?r`
              <div class="empty-state">
                ...
                ${s?"":r`
                        <div style="margin-top:12px;display:flex;gap:10px;">
                          <button
                            class="secondary sm"
                            @click=${async()=>{await ke("Year8Science","Year 8 Science","Science","+15559990001"),await U("I have Year 8 Science textbook in great shape","+15559990002")}}
                          >
            ...
            `:r`
              <div class="items-grid">
                ${a.map(i=>{const n=i.matchedAt||i.createdAt||Date.now(),o=2880*60*1e3,l=n+o-Date.now(),d=i.status!=="fulfilled"&&l<=0,v=Math.max(1,Math.ceil(l/(1e3*60*60))),f=$.find(p=>p.itemId===i.matchedItemId);return r`
                    <div
                      class="item-card"
                    ...
                    >
                      <div class="item-card-header">
                        ...
                        ${i.status==="fulfilled"?r`<span
                              ...
                              >`:d?r`<span
                                  ...
                                  >HOLD EXPIRED</span
                                >`:r`<span class="badge badge-matched"
                                  >48H HOLD (${v}h left)</span
                                >`}
                      </div>
                      ...
                      <div class="tags-row">
                        ...
                        ${i.handoverCode?r`<span
                                class="badge"
                                style="background:rgba(99,102,241,0.15);color:#818cf8;border:1px solid rgba(99,102,241,0.3);"
                                >Code: #${i.handoverCode}</span
                              >`:""}
                      </div>
                      ...
                      >
                        ${i.status==="fulfilled"?r`
                                ...
                                >
                                  ...
                                  <div>
                                    Buyer:
                                    <strong style="color:var(--text);">${i.userPhone}</strong>
                                  </div>
                      ...
                      <div class="card-footer">
                        <div style="display:flex;flex-direction:column;gap:2px;">
                          <div style="font-size:0.75rem;color:var(--text-dim);">
                            ${i.status==="fulfilled"?"Buyer Phone:":"Recipient Parent:"}
                            <strong style="color:var(--text);">${i.userPhone}</strong>
                          </div>
                        ...
                        <div style="display:flex;gap:6px;">
                          ${i.status!=="fulfilled"?r`
                                  <button
                                    ...
                                    @click=${async()=>{await y.confirmHandover({itemId:i.matchedItemId||"",demandId:i.demandId}),h("Handover confirmed! Book marked as sold."),await k()}}
                                  >
                                    Mark Sold
                                  </button>
                                `:""}
                          ${d?r`
                                  <button
                                    ...
                                    @click=${async()=>{await y.releaseHold({itemId:i.matchedItemId,demandId:i.demandId}),h("Hold released! Book returned to active catalog."),await k()}}
                                  >
                                    🔄 Release Hold
                                  </button>
                                `:""}
    ...
    <div style="display:flex;flex-direction:column;gap:24px;">
      ...
      <div class="card" style="border-left: 4px solid var(--accent, #6366f1)">
        ...
        >
          ...
          <button class="secondary sm" @click=${Ve}>🔐 Validate HMAC</button>
        </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button class="secondary sm" @click=${k}>🔄 Refresh Stream</button>
        </div>

        <div class="terminal-log">
          ${ce.length===0?r`<div style="color:var(--text-muted);padding:12px 0;">
                  Waiting for lifecycle events...
                </div>`:ce.slice().reverse().map(t=>r`
                      <div class="log-entry">
                        <span class="log-time"
                          >[${new Date(t.timestamp).toLocaleTimeString([],{hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"})}]</span
                        >

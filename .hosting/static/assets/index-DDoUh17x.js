...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Le=/'/g,Me=/"/g,Ne=/^(?:script|style|textarea|title)$/i,bt=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),d=bt(1),ee=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),De=new WeakMap,D=H.createTreeWalker(H,129);function ze(t,e){if(!we(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ee!==void 0?Ee.createHTML(e):e}const yt=(t,e)=>{const i=t.length-1,s=[];let n,r=e===2?"<svg>":e===3?"<math>":"",a=F;for(let o=0;o<i;o++){const l=t[o];let p,v,c=-1,g=0;for(;g<l.length&&(a.lastIndex=g,v=a.exec(l),v!==null);)g=a.lastIndex,a===F?v[1]==="!--"?a=Ie:v[1]!==void 0?a=Te:v[2]!==void 0?(Ne.test(v[2])&&(n=RegExp("</"+v[2],"g")),a=L):v[3]!==void 0&&(a=L):a===L?v[0]===">"?(a=n??F,c=-1):v[1]===void 0?c=-2:(c=a.lastIndex-v[2].length,p=v[1],a=v[3]===void 0?L:v[3]==='"'?Me:Le):a===Me||a===Le?a=L:a===Ie||a===Te?a=F:(a=L,n=void 0);const x=a===L&&t[o+1].startsWith("/>")?" ":"";r+=a===F?l+ht:c>=0?(s.push(p),l.slice(0,c)+Re+l.slice(c)+E+x):l+E+(c===-2?o:x)}return[ze(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class te{constructor({strings:e,_$litType$:i},s){let n;this.parts=[];let r=0,a=0;const o=e.length-1,l=this.parts,[p,v]=yt(e,i);if(this.el=te.createElement(p,s),D.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(n=D.nextNode())!==null&&l.length<o;){if(n.nodeType===1){if(n.hasAttributes())for(const c of n.getAttributeNames())if(c.endsWith(Re)){const g=v[a++],x=n.getAttribute(c).split(E),w=/([.?@])?(.*)/.exec(g);l.push({type:1,index:r,name:w[2],strings:x,ctor:w[1]==="."?$t:w[1]==="?"?At:w[1]==="@"?wt:de}),n.removeAttribute(c)}else c.startsWith(E)&&(l.push({type:6,index:r}),n.removeAttribute(c));if(Ne.test(n.tagName)){const c=n.textContent.split(E),g=c.length-1;if(g>0){n.textContent=oe?oe.emptyScript:"";for(let x=0;x<g;x++)n.append(c[x],Z()),D.nextNode(),l.push({type:2,index:++r});n.append(c[g],Z())}}}else if(n.nodeType===8)if(n.data===Be)l.push({type:2,index:r});else{let c=-1;for(;(c=n.data.indexOf(E,c+1))!==-1;)l.push({type:7,index:r}),c+=E.length-1}r++}}static createElement(e,i){const s=H.createElement("template");return s.innerHTML=e,s}}function O(t,e,i=t,s){var a,o;if(e===ee)return e;let n=s!==void 0?(a=i._$Co)==null?void 0:a[s]:i._$Cl;const r=X(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==r&&((o=n==null?void 0:n._$AO)==null||o.call(n,!1),r===void 0?n=void 0:(n=new r(t),n._$AT(t,i,s)),s!==void 0?(i._$Co??(i._$Co=[]))[s]=n:i._$Cl=n),n!==void 0&&(e=O(t,n._$AS(t,e.values),n,s)),e}class xt{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,n=((e==null?void 0:e.creationScope)??H).importNode(i,!0);D.currentNode=n;let r=D.nextNode(),a=0,o=0,l=s[0];for(;l!==void 0;){if(a===l.index){let p;l.type===2?p=new ae(r,r.nextSibling,this,e):l.type===1?p=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(p=new kt(r,this,e)),this._$AV.push(p),l=s[++o]}a!==(l==null?void 0:l.index)&&(r=D.nextNode(),a++)}return D.currentNode=H,n}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class ae{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,s,n){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=n,this._$Cv=(n==null?void 0:n.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=O(this,e,i),X(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==ee&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):mt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&X(this._$AH)?this._$AA.nextSibling.data=e:this.T(H.createTextNode(e)),this._$AH=e}$(e){var r;const{values:i,_$litType$:s}=e,n=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=te.createElement(ze(s.h,s.h[0]),this.options)),s);if(((r=this._$AH)==null?void 0:r._$AD)===n)this._$AH.p(i);else{const a=new xt(n,this),o=a.u(this.options);a.p(i),this.T(o),this._$AH=a}}_$AC(e){let i=De.get(e.strings);return i===void 0&&De.set(e.strings,i=new te(e)),i}k(e){we(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,n=0;for(const r of e)n===i.length?i.push(s=new ae(this.O(Z()),this.O(Z()),this,this.options)):s=i[n],s._$AI(r),n++;n<i.length&&(this._$AR(s&&s._$AB.nextSibling,n),i.length=n)}_$AR(e=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);e!==this._$AB;){const n=Pe(e).nextSibling;Pe(e).remove(),e=n}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class de{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,n,r){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=i,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(e,i=this,s,n){const r=this.strings;let a=!1;if(r===void 0)e=O(this,e,i,0),a=!X(e)||e!==this._$AH&&e!==ee,a&&(this._$AH=e);else{const o=e;let l,p;for(e=r[0],l=0;l<r.length-1;l++)p=O(this,o[s+l],i,l),p===ee&&(p=this._$AH[l]),a||(a=!X(p)||p!==this._$AH[l]),p===b?e=b:e!==b&&(e+=(p??"")+r[l+1]),this._$AH[l]=p}a&&!n&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class $t extends de{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}}class At extends de{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}}class wt extends de{constructor(e,i,s,n,r){super(e,i,s,n,r),this.type=5}_$AI(e,i=this){if((e=O(this,e,i,0)??b)===ee)return;const s=this._$AH,n=e===b&&s!==b||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==b&&(s===b||n);n&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class kt{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){O(this,e)}}const ve=V.litHtmlPolyfillSupport;ve==null||ve(te,ae),(V.litHtmlVersions??(V.litHtmlVersions=[])).push("3.3.3");const St=(t,e,i)=>{const s=e;let n=s._$litPart$;return n===void 0&&(s._$litPart$=n=new ae(e.insertBefore(Z(),null),null,void 0,{})),n._$AI(t),n},Ct=document.getElementById("app");let m="available",P="all",R=[],C=[],le=[],_t=null,M=null,ie=!1,J="",ge=null,T="",k="all",I="all",j="all",B="all",S="all",se="",ne="",Q=!0,N=!1,$=null,xe=!1,G=!1,Y="",re="",he="Mathematics",me="+15550199002";function h(t){J=t,ge&&clearTimeout(ge),ge=setTimeout(()=>{J="",u()},1e4)}function ke(t){if(!t)return"Unknown date";const e=Date.now(),i=Math.floor((e-t)/1e3);if(i<60)return"Just now";const s=Math.floor(i/60);if(s<60)return`${s}m ago`;const n=Math.floor(s/60);if(n<24)return`${n}h ago`;const r=Math.floor(n/24);return r===1?"Yesterday":r<30?`${r}d ago`:new Date(t).toLocaleDateString()}function U(t){return t?new Date(t).toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):""}function ce(t){switch(t){case"Mathematics":return"badge-math";case"Science":return"badge-science";case"Languages":return"badge-languages";case"Humanities":return"badge-humanities";case"Arts":return"badge-arts";default:return"badge-active"}}function Oe(t){switch(t){case"PrimarySchool":return"badge-primary";case"MiddleSchool":return"badge-middle";case"HighSchool":return"badge-high";case"UniversityPrep":return"badge-uniprep";default:return"badge-active"}}function Pt(t){switch(t){case"PrimarySchool":return"Primary (Years 1-6)";case"MiddleSchool":return"Middle School (Years 7-9)";case"HighSchool":return"High School (Years 10-13)";case"UniversityPrep":return"Uni Prep";default:return t||"General"}}function je(t){switch(t){case"New":return d`
      ...
      `;default:return d`<span class="badge badge-active">${t||"Good"}</span>`}}function Ue(t){if(!t)return!0;const e=Date.now();if(S==="today"){const i=new Date;return i.setHours(0,0,0,0),t>=i.getTime()}if(S==="7days"){const i=e-6048e5;return t>=i}if(S==="30days"){const i=e-2592e6;return t>=i}if(S==="custom"){let i=!0;if(se){const s=new Date(se).setHours(0,0,0,0);t<s&&(i=!1)}if(ne){const s=new Date(ne).setHours(23,59,59,999);t>s&&(i=!1)}return i}return!0}function Et(t){return t.filter(e=>{if(T.trim()){const i=T.toLowerCase().trim();if(!(e.title&&e.title.toLowerCase().includes(i)||e.concept&&e.concept.toLowerCase().includes(i)||e.description&&e.description.toLowerCase().includes(i)||e.domain&&e.domain.toLowerCase().includes(i)||e.providerCategory&&e.providerCategory.toLowerCase().includes(i)||e.sellerPhone&&e.sellerPhone.toLowerCase().includes(i)))return!1}return!(k!=="all"&&e.domain!==k||I!=="all"&&e.providerCategory!==I||j!=="all"&&e.conditionType!==j||B!=="all"&&e.sellerPhone!==B||!Ue(e.createdAt))}).sort((e,i)=>{const s=e.createdAt||0,n=i.createdAt||0;return Q?n-s:s-n})}function We(t,e){return t.filter(i=>{if(i.status!==e)return!1;if(T.trim()){const s=T.toLowerCase().trim();if(!(i.requestedQuery&&i.requestedQuery.toLowerCase().includes(s)||i.concept&&i.concept.toLowerCase().includes(s)||i.domain&&i.domain.toLowerCase().includes(s)||i.userPhone&&i.userPhone.toLowerCase().includes(s)))return!1}return!(k!=="all"&&i.domain!==k||!Ue(i.createdAt))}).sort((i,s)=>{const n=i.createdAt||0,r=s.createdAt||0;return Q?r-n:n-r})}function It(){let t=0;return T.trim()&&t++,k!=="all"&&t++,I!=="all"&&t++,j!=="all"&&t++,B!=="all"&&t++,S!=="all"&&t++,t}function Fe(){T="",k="all",I="all",j="all",B="all",S="all",se="",ne="",u()}async function A(){ie=!0,u();try{try{await y.releaseExpiredHolds()}catch{}const[t,e,i,s,n]=await Promise.all([y.listInventory(),y.listDemands(),y.getLifecycleEvents(),y.getSecurityObservabilityStatus(),y.getSupplyGaps()]);R=t||[],C=e||[],le=i||[],_t=s||null,M=n||null}catch(t){console.error("Failed to load dashboard data:",t),h(`❌ Failed to load data: ${t.message}`)}finally{ie=!1,u()}}async function Tt(t){xe=!0,N=!0,$=null,u();try{$=await y.getSellerStorefront(t)}catch(e){h(`❌ Failed to load seller storefront: ${e.message}`),N=!1}finally{xe=!1,u()}}async function Lt(){try{const t=await y.verifyWebhook("subscribe","my_verify_token_123",`challenge_${Date.now()}`);t.status===200?h(`✅ Handshake Verified! Echoed challenge: "${t.challenge}"`):h(`❌ Verification failed: ${t.error}`)}catch(t){h(`❌ Error verifying webhook: ${t.message}`)}A()}async function z(t,e="+15550199001"){var i,s,n,r;h(`🚀 Processing simulated WhatsApp message: "${t}"...`),u();try{const a={media_id:`media_${Date.now()}`,from_phone:e,message_text:t},o=await y.handleWebhook(a);((i=o.result)==null?void 0:i.status)==="matched"?(h(`🎉 Match Connected! Matched wishlist ID: ${o.result.matchedDemandId}`),m="matches"):((s=o.result)==null?void 0:s.status)==="needs_year_clarification"?h("ℹ️ Clarification Prompt Triggered: Bot asked parent for school year/grade!"):((n=o.result)==null?void 0:n.status)==="greeting"?h("👋 Greeting Handled: Welcome & Guide sent."):(h(`📦 Book Listed into Inventory! Item ID: ${((r=o.result)==null?void 0:r.itemId)||"saved"}`),m="available")}catch(a){h(`❌ Webhook simulation error: ${a.message}`)}A()}async function $e(t,e,i="Mathematics",s="+15550199002"){h(`⏳ Registering demand for "${e}" (${t})...`),u();try{const n=await y.createDemand(s,e,t,i);h(`✨ Wishlist demand registered: "${n.requestedQuery}"!`),G=!1,m="pendings"}catch(n){h(`❌ Error adding demand: ${n.message}`)}A()}async function Ye(t){try{await y.deleteDemand(t),h("🗑️ Removed demand entry."),C=C.filter(e=>e.demandId!==t),u()}catch(e){h(`❌ Error removing demand: ${e.message}`)}}async function Mt(t){try{await y.deleteInventory(t),h("🗑️ Removed inventory item."),R=R.filter(e=>e.itemId!==t),u()}catch(e){h(`❌ Error removing inventory: ${e.message}`)}}async function Ge(){h("🔒 Validating HMAC-SHA256 Payload Signature..."),u();try{const t="secret_key_whatsapp_demo_1234",e=JSON.stringify({test:"hmac-verification",timestamp:Date.now()}),i=new TextEncoder,s=await crypto.subtle.importKey("raw",i.encode(t),{name:"HMAC",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("HMAC",s,i.encode(e)),r=Array.from(new Uint8Array(n)).map(o=>o.toString(16).padStart(2,"0")).join("");(await y.validateSignature(e,`sha256=${r}`,t)).valid?h("🛡️ HMAC Verification SUCCESS: Timing-safe cryptographic signature verified."):h("❌ HMAC Verification Failed!")}catch(t){h(`❌ HMAC test error: ${t.message}`)}A()}function Dt(){const t=C.filter(n=>n.status==="pending").length,e=C.filter(n=>n.status==="matched").length,i=R.length,s=le.length;return d`
    <div class="stats-row">
  ...
  `}function Ht(){const t=C.filter(s=>s.status==="pending").length,e=C.filter(s=>s.status==="matched").length,i=R.length;return d`
    <div class="tabs-nav">
      <button
  ...
  `:""}function Se(t=!0){const e=It(),i=Array.from(new Set(R.map(s=>s.sellerPhone).filter(Boolean)));return d`
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div style="display:flex;gap:10px;align-items:center;">
          ...
          <button class="secondary sm" @click=${A}>
  ...
  `}function Ot(){return N?d`
    ...
    >
      <div class="card" style="width:100%;max-width:680px;max-height:85vh;overflow-y:auto;background:#111827;border:1px solid var(--surface-border-hover);box-shadow:0 25px 50px -12px rgba(0,0,0,0.9);display:flex;flex-direction:column;gap:18px;">
        ${xe?d`<div style="text-align:center;padding:40px 0;color:var(--text-muted);">Loading Family Storefront...</div>`:$?d`
              <div style="display:flex;justify-content:space-between;align-items:flex-start;border-bottom:1px solid rgba(255,255,255,0.08);padding-bottom:14px;">
                <div>
                  ...
                  <h3 style="font-size:1.4rem;">Parent Storefront: ${$.sellerPhone}</h3>
                  <p style="margin:4px 0 0 0;font-size:0.85rem;color:var(--text-muted);">
                    Total <strong>${$.totalBooks} textbooks</strong> available across multiple grades.
                  </p>
                </div>
                  ...
                  ${$.bundles.map(t=>d`
                      <div style="background:rgba(255,255,255,0.04);border:1px solid var(--surface-border);border-radius:10px;padding:12px;">
                        ...
                        <button
                          ...
                          @click=${()=>{h(`💬 WhatsApp Bundle Request sent to seller ${$==null?void 0:$.sellerPhone} for all ${t.count} books in ${t.grade}!`)}}
                        >
              ...
              <div style="display:flex;justify-content:flex-end;gap:10px;border-top:1px solid rgba(255,255,255,0.08);padding-top:12px;">
                <button
                  class="secondary"
                  @click=${()=>{B=($==null?void 0:$.sellerPhone)||"all",N=!1,u()}}
                >
  ...
  `}function Ut(){const t=We(C,"matched");return d`
    <div class="card">
      <div class="card-header">
        ...
        <div style="display:flex;gap:8px;">
          <button
            ...
            @click=${async()=>{const e=await y.releaseExpiredHolds();h(`🧹 Swept holds: ${e.releasedCount} expired hold(s) released back to active inventory.`),await A()}}
          >
            🧹 Sweep Expired Holds
          </button>
          <button class="secondary sm" @click=${A}>
      ...
      ${t.length===0?d`
          ...
          `:d`
            <div class="items-grid">
              ${t.map(e=>{const i=e.matchedAt||e.createdAt||Date.now(),s=2880*60*1e3,n=i+s-Date.now(),r=e.status!=="fulfilled"&&n<=0,a=Math.max(1,Math.ceil(n/(1e3*60*60)));return d`
                  <div
                    class="item-card"
                  ...
                  >
                    ...
                    >
                      ${e.status==="fulfilled"?"Handover completed! Book marked as sold and removed from active catalog.":r?"⚠️ 48-Hour hold has elapsed without physical exchange. Book can be returned to community circulation.":`⏳ 48-Hour Reservation Active (${a}h remaining). Matched parents introduced via WhatsApp.`}
                    </div>
                      ...
                      <div style="display:flex;gap:6px;">
                        ${e.status!=="fulfilled"?d`
                              <button
                                ...
                                @click=${async()=>{await y.confirmHandover({itemId:e.matchedItemId||"",demandId:e.demandId}),h("Handover confirmed! Book marked as sold."),await A()}}
                              >
                                Mark Sold
                              </button>
                            `:""}
                        ${r?d`
                              <button
                                ...
                                @click=${async()=>{await y.releaseHold({itemId:e.matchedItemId,demandId:e.demandId}),h("Hold released! Book returned to active catalog."),await A()}}
                              >
                                🔄 Release Hold
                              </button>
                            `:""}
